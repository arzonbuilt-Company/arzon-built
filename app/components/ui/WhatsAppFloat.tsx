...
export function WhatsAppFloat() {
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
      {/* Pulse ring — starts after button appears */}
      <motion.div
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.88 }}
        className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center shadow-lime-glow"
        style={{ background: '#25d366' }}
      >
